...
t=0:(N-1);
kc=N/4; %(JB) N/32;  
s=(1+sm).* cos(2*pi*kc*t/N)/2;%(JB) I copyied these lines in class, they worked pretty well
...
save 'Sandoval_signal' s;
save 'Sandoval_Bcheck' Bcheck;
